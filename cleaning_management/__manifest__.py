...
#############################################################################
{
    ...
    'version': '17.0.1.0.0',
    "category": "Industries",
    'summary': """Cleaning/Service Management with Online Booking System""",
    'description': """This module facilitates the booking of cleaning/service processes 
    and effectively manages the procedures.""",
    'author': 'Cybrosys Techno Solutions',
    'company': 'Cybrosys Techno Solutions',
    'maintainer': 'Cybrosys Techno Solutions',
    'website': "https://cybrosys.com/",
    'depends': ['base', 'website', 'hr', 'account', 'sale'],
    'data': [
        ...
        'views/cleaning_service_type_views.xml',
